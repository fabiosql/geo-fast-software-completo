/* Projeto para disciplina de Objetos Inteligentes conectados - 5 Semestre Mackenzie - (IOT) Rastreador GPS com ESP32 TTGO
 * Autor do Código fonte que foi utilizado como base: Pedro Bertoleti
 */
#include <TinyGPS++.h>
#include <axp20x.h>
#include <WiFi.h>
...
const char* topico_publish_mqtt = "geofast_db5b410e-fabd-4361-a10e-547a7f9495dd";
...
void loop() 
{
    /* todas as funcionalidades são feitas pelas tarefas task_leitura_gps e task_wifi_mqtt */
}
...
void task_leitura_gps( void *pvParameters )
{
    ...
    while(1)
    {
        ...
        vTaskDelay(TEMPO_ENTRE_POSICOES_GPS);
...
void task_wifi_mqtt( void *pvParameters )
{
    ...
    while(1)
    {
        ...
        */
        ...
        {     
            sprintf(msg_mqtt,"{\"lat\":%f,\"lng\":%f,\"token\":\"%s\"}", posicao_gps_recebida.latitude, posicao_gps_recebida.longitude,TOKEN);
